...
async function generateBaseline() {
  ...
  execSync("npx vitest run --coverage --coverage.reporter=json-summary --coverage.reporter=text --coverage.reportsDirectory=reports/coverage", { stdio: 'inherit', shell: true });
  log('Running jscpd...');
